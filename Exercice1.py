...
d = widgets.Dropdown(options = ['1', 'Total'], description = 'population')
e = widgets.Dropdown(options = ['0', '1', 'Total'], description = 'chomage')
...
liste_code = df_chomage_cool['GEO']
liste_valeur = df_chomage_cool['OBS_VALUE']
